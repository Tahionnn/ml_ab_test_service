...
class CreateModelRequest(BaseModel):
    ...
    status: ModelStatus = Field(default=ModelStatus.STAGING)
...
class UpdateModelRequest(BaseModel):
    ...
    serving_endpoint: str | None = Field(None, examples=["/predict/new-path"])
    status: ModelStatus | None = Field(None, examples=[ModelStatus.PRODUCTION])
...
class ChangeStatusRequest(BaseModel):
    status: ModelStatus = Field(..., examples=[ModelStatus.PRODUCTION])
...
class ModelResponse(CreateModelRequest):
    model_config = ConfigDict(
